const ArrowDataTransferHorizontalIcon = ({ color, ...props }: React.SVGProps<SVGSVGElement>) => (
...
const Home05Icon = ({ color, ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={color} fill={"none"} {...props}>
...
const Clock03Icon = ({ color, ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={color} fill={"none"} {...props}>
...
const MoneySendSquareIcon = ({ color, ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={color} fill={"none"} {...props}>
...
const Cancel01Icon = ({ color, ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={color} fill={"none"} {...props}>
...
const SquareLock02Icon = ({ color, ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={color} fill={"none"} {...props}>
