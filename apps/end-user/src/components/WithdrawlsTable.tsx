...
export default function WithdrawlsTable({ withdrawalTransactions }: { withdrawalTransactions: RampTransaction[] }) {

  return <div className="text-sm">
    {withdrawalTransactions.map(transaction => <TableRow key={transaction.id} transaction={transaction} />)}
  </div>
}
